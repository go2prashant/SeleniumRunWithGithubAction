...
public class Data {
     ...
     */
    public static final String FIRST_NAME = "Prashant";
    public static final String LAST_NAME = "Sinha";
    public static final String EMAIL = "go2prashant@gmail.com";
    public static final String TELEPHONE = "+1234567890";

    public static final String PASSWORD = "a1b2c3d4e5f6";
